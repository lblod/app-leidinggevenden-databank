defmodule Dispatcher do
  ...
  match "/bestuursfuncties/*path" do
    Proxy.forward conn, path, "http://resource/bestuursfuncties/"
  end
  match "/functionarissen/*path" do
    Proxy.forward conn, path, "http://resource/functionarissen/"
  end
  ...
  match "/fractietypes/*path" do
    Proxy.forward conn, path, "http://resource/fractietypes/"
  end
